        ...
        try {
            for (const group of groups.values()) {
                ...
                for (let index = 0; index < count; index++) {
                    ...
                    await new mssql_1.default.Request(transaction).input('id', mssql_1.default.Int, room.id).input('latitude', mssql_1.default.Decimal(10, 7), latitude).input('longitude', mssql_1.default.Decimal(10, 7), longitude).query('UPDATE dbo.PhongHoc SET Latitude=@latitude, Longitude=@longitude WHERE PhongHocID=@id');
                }
            }
